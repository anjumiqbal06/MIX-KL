...
def get_args():
    ...
    parser.add_argument('--model_path', type=str, default='E:/MIX-KL/training_output/cifar10/epsilon_8/alpha_8/model_ResNet18/factor_0.7/mixup/mixup_alpha_1.0/EMA_value_0.82/lamda_12/best_model.pth')
...
AT_pgd_loss_10, AT_pgd_acc_7 = evaluate_pgd(test_loader, target_model, 7, 1, epsilon / std)
AT_pgd_loss_50, AT_pgd_acc_20 = evaluate_pgd(test_loader, target_model, 20, 1, epsilon / std)
...
print('AT_pgd_acc_10:', AT_pgd_acc_7)
print('AT_pgd_acc_50:', AT_pgd_acc_20)
